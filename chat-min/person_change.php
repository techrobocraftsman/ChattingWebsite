	...
	if(isset($_POST['inbox_info_update'])){
		...
		?>
			<div class="r">
				...
				<div class="c username"><div class="choice info"><?php echo $_SESSION['second_person'];?></div></div>
				<div class="c img"><div class="pic"><img src="<?php if($_SESSION['second_img']!='')echo $_SESSION['second_img'];else echo 'images/Screenshot_2.png'?>" alt=""></div></div>
			</div>
